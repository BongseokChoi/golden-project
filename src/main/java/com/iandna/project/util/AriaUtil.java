...
public class AriaUtil {
	...
	private static final Logger logger = LoggerFactory.getLogger(AriaUtil.class);
	
    public static final String mPrivatekey= "pfiGR7M6HLBFuVyZM1bS3I2rVSJMWljT0zRG";
     ...
     *Aria 복호화
     */
    public static String Decrypt(String strHex)
            throws InvalidKeyException, UnsupportedEncodingException  {
        if (strHex==null || strHex.equals("")) return "";
        String privateKey = mPrivatekey;
        String result;
    ...
    public static String ariaDecrypt(String strHex)
        ...
        try {
            String privateKey = "pfiGR7M6HLBFuVyZM1bS3I2rVSJMWljT0zRG";
    ...
    public static String ariaCharEncrypt(String str, String charset, String server)
        ...
        if (str==null || str.equals("")) return "";
        String privateKey = "";
        if(server.equals("regi")) privateKey = "pfiGR7M6HLBFuVyZM1bS3I2rVSJMWljT0zRG";
        else privateKey = "pfiGR7M6HLBFuVyZM1bS3I2rVSJMWljT0zRG";
    ...
    public static void test() {
        try {
            String resultEn = AriaUtil.Encrypt("l33526168k!");
            logger.debug("암호화 : " + AriaUtil.Encrypt("goonggu1234!"));
            logger.debug("복호화 : " + AriaUtil.Decrypt("95527A599BA46CB2721BAED93A608158"));
